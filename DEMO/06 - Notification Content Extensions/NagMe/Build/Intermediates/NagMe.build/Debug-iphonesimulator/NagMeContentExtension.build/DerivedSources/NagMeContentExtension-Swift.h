...
SWIFT_CLASS("_TtC21NagMeContentExtension26NotificationViewController")
...
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified speakerLabel;
- (void)viewDidLoad;
...
@interface UIView (SWIFT_EXTENSION(NagMeContentExtension))
- (void)shake;
- (void)cancelShake;
@end
